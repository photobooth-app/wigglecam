...
os.environ["QT_QPA_PLATFORM"] = "eglfs"  # TODO: check later again
...
picam2.configure(picam2.create_preview_configuration(main={"size": (800, 480)}))
...
qpicamera2 = QPicamera2(picam2, width=800, height=480, keep_ar=True)
